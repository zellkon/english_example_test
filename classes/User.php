...
class User
{
	...
	public function userRegistration($email)
	{
		...
		else if(filter_var($mail, FILTER_VALIDATE_EMAIL) === false)
		{
			...
			if($chkResult != false)
			{
				...
				$query = "INSERT INTO tbl_user(userName, userPass, userEmail, userStatus) VALUES('', '$pass', '$mail', '0')";
				//echo $query;exit;
				...
				if($inserted_row){
					echo "Đã đăng ký thành công mật khẩu đăng nhập mặc định là 1 !";
					exit;
				}
				else{
					echo "Chưa đăng ký!";
